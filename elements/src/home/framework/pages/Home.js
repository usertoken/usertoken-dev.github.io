...
class Home extends React.Component {
  ...
  return (
    <NavPageContainer hasPadding>
      ...
      <h2 className="home-text">Usertoken</h2>
      ...
      <br/><span className="home-text">Usertoken Home</span>

      <div className="link-container">
        <a href="https://www.usertoken.com" target="_blank" rel="noreferrer"><NpmIcon /></a>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="https://usertoken.com" target="_blank" rel="noreferrer"><GithuIcon /></a>
      </div>
