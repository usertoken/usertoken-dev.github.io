...
import {
  NavBar, NavBarLink, NavBarLinkFluent, NavSearchBox, SystemThemeFollower, RegisterFluentEffect
} from './lib'
...
class FrameworkHome extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
        ...
        title: this.props.title? this.props.title : 'Usertoken',
        homepage: this.props.homepage? this.props.homepage : '/home',
    }
  }
  ...
  return (
    <>
     <Router basename={this.state.homepage}>
